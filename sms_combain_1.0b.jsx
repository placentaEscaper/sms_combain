...
//UI
var currentVersion = "sms_combain_1.0b"
...
speedSliderText_1.onChange = function() {
    speedSlider_1.value = Math.round(parseInt(speedSliderText_1.text) * 10 )/10;
}
...
speedSliderText_2.onChange = function() {
    speedSlider_2.value = Math.round(parseInt(speedSliderText_2.text) * 10 )/10;
}
...
speedSliderText_3.onChange = function() {
    speedSlider_3.value = Math.round(parseInt(speedSliderText_3.text) * 10 )/10;
}
...
speedSliderText_4.onChange = function() {
    speedSlider_4.value = Math.round(parseInt(speedSliderText_4.text) * 10 )/10;
}
...
speedSliderText_5.onChange = function() {
    speedSlider_5.value = Math.round(parseInt(speedSliderText_5.text) * 10 )/10;
}
...
speedSliderText_6.onChange = function() {
    speedSlider_6.value = Math.round(parseInt(speedSliderText_6.text) * 10 )/10;
}
...
speedSliderText_7.onChange = function() {
    speedSlider_7.value = Math.round(parseInt(speedSliderText_7.text) * 10 )/10;
}
...
speedSliderText_8.onChange = function() {
    speedSlider_8.value = Math.round(parseInt(speedSliderText_8.text) * 10 )/10;
}
